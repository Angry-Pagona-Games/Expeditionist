...
AExpeditionistCharacter::AExpeditionistCharacter(const FObjectInitializer& ObjectInitializer)
...
void AExpeditionistCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AExpeditionistCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AExpeditionistCharacter::Move);
